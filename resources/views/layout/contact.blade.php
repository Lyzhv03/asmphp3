...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('courses-master/assets/css/hamburgers.min.css') }}">
                    ...
                    <div class="col-xl-2 col-lg-2">
                        <div class="logo">
                            <a href="{{ route('book.home') }}"><img
                                    src="{{ asset('courses-master/assets/img/logo/logo.png') }}" alt=""></a>
                        </div>
                    </div>
                    <div class="col-xl-10 col-lg-10">
                        <div class="menu-wrapper d-flex align-items-center justify-content-end">
                            ...
                            <div class="main-menu d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        <li class="active"><a href="{{route('book.home')}}">Home</a></li>
                                        ...
                                        @if (Auth::check())
                                            ...
                                            <a class="" href="{{ route('logout') }}" data-toggle=""
                                                data-target="">
